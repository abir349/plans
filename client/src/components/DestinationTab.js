            ...
            ?.map((el) => (
              <tr>
                ...
                <td className="last_td">
                  <EditDest el={el} ping={ping} setping={setping} />
                  <button
                    style={{
                    ...
                    onClick={() => {
                      dispatch(deletedestination(el._id));
                      setping(!ping);
                    }}
                  >
                    X
